...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel runat="server" ID="PageControls">
        ...
        <asp:Label runat="server">Email: </asp:Label><asp:TextBox runat="server" ID="EmailTB"></asp:TextBox>
        <asp:Button runat="server" ID="RequestButton" Text="Request Change Of Password" OnClick="RequestButton_Click" />
        <asp:Label runat="server" ID="NewPasswordLabel">New Password: </asp:Label><asp:TextBox runat="server" ID="NewPasswordTB" TextMode="Password"></asp:TextBox>
        <asp:Label runat="server" ID="ConfirmNewPasswordLabel">Confirm New Password: </asp:Label><asp:TextBox runat="server" ID="ConfirmNewPasswordTB" TextMode="Password"></asp:TextBox>
