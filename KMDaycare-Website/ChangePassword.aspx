            ...
            <div id="changepassword" style="margin-top: 50px;" class="mainbox col-lg-6 col-lg-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info">
                    ...
                    <div style="margin-top: 10px" class="form-group">
                        ...
                        <div style="margin-bottom: 25px" class="input-group">
                            <asp:TextBox runat="server" ID="NewPasswordTB" placeholder="New Password" CssClass="form-control" TextMode="Password" MaxLength="25"></asp:TextBox>
                        </div>
                        ...
                        <div style="margin-bottom: 25px" class="input-group">
                            <asp:TextBox runat="server" ID="ConfirmNewPasswordTB" placeholder="Confirm New Password" CssClass="form-control" TextMode="Password" MaxLength="25"></asp:TextBox>
                        </div>
                           <div style="margin-top: 10px" class="form-group">
                        <div class="col-sm-12 controls">
